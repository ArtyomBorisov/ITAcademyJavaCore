...
public class PresentationArrays4Main {
    public static void main(String[] args) {
        PresentationArrays4 util = new PresentationArrays4();
        ...
        int[] minArr = util.findTwoMinElements(arr);

        System.out.println("Два наименьших (минимальных) элемента массива: " + minArr[0] + " " + minArr[1]);
    }
}
